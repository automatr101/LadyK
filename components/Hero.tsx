...
export function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-16 pb-16 px-6 text-center hero-gradient overflow-hidden">
      {/* Background Decor */}
      ...
      <div className="container mx-auto relative z-10">
        <motion.div 
          ...
          className="inline-block bg-gold/15 border border-gold/40 text-gold-light text-[11px] font-semibold tracking-[3px] uppercase px-5 py-2 rounded-full mb-8"
        >
        ...
        <motion.h1 
          ...
          className="text-4xl md:text-7xl font-serif font-black leading-[1.1] max-w-[800px] mx-auto mb-6"
        >
        ...
        <motion.p 
          ...
          className="text-lg md:text-[20px] text-[#bbb] max-w-[560px] mx-auto leading-[1.7] mb-12 font-light"
        >
